...
public class MyAboutJDialog extends JDialog {
	...
	public MyAboutJDialog() {
		...
		lblNewLabel.setIcon(new ImageIcon(new ImageIcon(MyAboutJDialog.class.getResource("/com/ekielzan/JDBCChecker/img/Gilles_Dejeneffe_4.jpg")).getImage().getScaledInstance(155, 268, Image.SCALE_SMOOTH)));
